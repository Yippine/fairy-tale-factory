...
urlpatterns = [
    ...
    path('setfetchtextpromptpagenew/', lambda request: handle_post_request(request)),
    path('fetchtextpromptnew/', views.fetch_text_prompt_new, name='menu/fetch_text_prompt_new'),
