...
urlpatterns = [
    ...
    path('setfetchstorypromptpagenew/', lambda request: handle_post_request(request)),
    path('fetchstorypromptnew/', views.fetch_story_prompt_new, name='menu/fetch_story_prompt_new'),
