...
urlpatterns = [
    ...
    path('setfetchtextcommandpagenew/', lambda request: handle_post_request(request)),
    path('fetchtextcommandnew/', views.fetch_text_command_new, name='menu/fetch_text_command_new'),
