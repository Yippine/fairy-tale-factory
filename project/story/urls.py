...
urlpatterns = [
    ...
    path('mainroledetailsbydata/<int:item_id>/', views.main_role_details_by_data, name='menu/main_role_details_by_data'),
    path('suproledetailsbydata/<int:item_id>/', views.sup_role_details_by_data, name='menu/sup_role_details_by_data'),
    path('itemdetailsbydata/<int:item_id>/', views.item_details_by_data, name='menu/item_details_by_data'),
]
